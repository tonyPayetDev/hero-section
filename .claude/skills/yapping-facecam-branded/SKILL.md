...
- **Format** : 1080×1920, 30 fps, 25-40s. Fond matte black `#0a0a0f` + néons jaune `#FFD700` / violet `#8b5cf6` / orange.  ← valeurs fixées dans `_shared/CHARTE.md`, ne pas les redéfinir ici
